...
namespace bugraGundoganASP.webUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Checkout(OrderModel model)
        {
            ...
            var cart_deux = _cartService.GetCartByUserId(_userManager.GetUserId(User));

            model.CartModel = new CartModel()
            {
                CartId = cart_deux.Id,
                CartItems = cart_deux.CartItems.Select(i => new CartItemModel()
                {
                    CartItemId = i.Id,
                    ProductId = i.ProductId,
                    Name = i.Product.Name,
        ...
        private void SaveOrder(OrderModel model, Payment payment, string userId)
        {
            ...
            {
                var orderItem = new bugraGundoganASP.entity.OrderItem()
                {
                    Price = item.Price,
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-eZELQ6cMUqW0JdPvYKXCgBBRVIJib8bc";
            options.SecretKey = "sandbox-XuY2KmDTWyK9sthO5izrmv6ylksuMdDU";
