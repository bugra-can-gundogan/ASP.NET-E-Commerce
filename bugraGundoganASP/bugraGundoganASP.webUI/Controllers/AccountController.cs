...
using bugraGundoganASP.webUI.Extensions;
    ...
    public class AccountController:Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if(result.Succeeded)
            {
                ...
                // email
                await _emailSender.SendEmailAsync(model.Email,"Hesabınızı onaylayınız.",$"Lütfen email hesabınızı onaylamak için linke <a href='https://localhost:7173{url}'>tıklayınız.</a>");
                TempData.Put("message", new AlertMessage()
                {
                    Title = "Lütfen e-mail adresinizi onaylayın!",
                    Message = $"Hesabınızı onaylayabilmeniz için {model.Email} adresine bir e-posta gönderilmiştir.",
                    AlertType = "warning"
                });
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            // email
            await _emailSender.SendEmailAsync(Email,"Reset Password",$"Parolanızı yenilemek için linke <a href='https://localhost:7173{url}'>tıklayınız.</a>");
